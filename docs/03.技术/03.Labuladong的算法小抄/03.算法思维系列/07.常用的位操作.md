...
<Pictures figure="/pictures/%E4%BD%8D%E6%93%8D%E4%BD%9C/1.png" locate="doc-fucking-algorithm" />

其核心逻辑就是，`n - 1` 一定可以消除最后一个 1，同时把其后的 0 都变成 1，这样再和 `n` 做一次 `&` 运算，就可以仅仅把最后一个 1 变成 0 了。

1. **计算汉明权重（Hamming Weight）**

<Pictures figure="/pictures/%E4%BD%8D%E6%93%8D%E4%BD%9C/title.png" locate="doc-fucking-algorithm" />
...
<Pictures figure="/pictures/位操作/title1.png" locate="doc-fucking-algorithm" />
