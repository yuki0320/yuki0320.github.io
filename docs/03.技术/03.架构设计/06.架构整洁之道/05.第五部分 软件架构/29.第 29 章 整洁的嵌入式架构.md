---
title: 第 29 章 整洁的嵌入式架构
date: 2021-01-07 14:38:18
permalink: /pages/9c7530/
categories:
  - 技术
  - 技术文档
  - 架构整洁之道
...
<Pictures figure="/un/CH-UN29.jpg" locate="doc-clean-architecture" />
...
<Figures locate="doc-clean-architecture" type="jpg"  figure="29-1">Three layers</Figures>
...
<Figures locate="doc-clean-architecture" type="jpg"  figure="29-2">Hardware must be separated from the rest of the system</Figures>
...
<Figures locate="doc-clean-architecture" type="jpg"  figure="29-3">The line between software and firmware is a bit fuzzier than the line between code and hardware</Figures>
...
<Figures locate="doc-clean-architecture" type="jpg"  figure="29-4">The hardware abstraction layer</Figures>
...
<Figures locate="doc-clean-architecture" type="jpg"  figure="29-5">Adding in an operating system</Figures>
...
<Figures locate="doc-clean-architecture" type="jpg"  figure="29-6">The operating system abstraction layer</Figures>
