...
<Pictures figure="/pictures/pancakeSort/1.jpg" locate="doc-fucking-algorithm" />

设想一下用锅铲翻转一堆烧饼的情景，其实是有一点限制的，我们每次只能将最上面的若干块饼子翻转：

<Pictures figure="/pictures/pancakeSort/2.png" locate="doc-fucking-algorithm" />

我们的问题是，**如何使用算法得到一个翻转序列，使得烧饼堆变得有序**？

首先，需要把这个问题抽象，用数组来表示烧饼堆：

<Pictures figure="/pictures/pancakeSort/title.png" locate="doc-fucking-algorithm" />
...
<Pictures figure="/pictures/pancakeSort/3.jpg" locate="doc-fucking-algorithm" />

那么，原问题的规模就可以减小，递归调用 `pancakeSort(A, n-1)` 即可：

<Pictures figure="/pictures/pancakeSort/4.jpg" locate="doc-fucking-algorithm" />
