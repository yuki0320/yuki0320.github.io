...
<Pictures figure="/pictures/mergeInterval/title.png" locate="doc-fucking-algorithm" />
...
<Pictures figure="/pictures/mergeInterval/1.jpg" locate="doc-fucking-algorithm" />

**显然，对于几个相交区间合并后的结果区间 `x`，`x.start` 一定是这些相交区间中 `start` 最小的，`x.end` 一定是这些相交区间中 `end` 最大的。**

<Pictures figure="/pictures/mergeInterval/2.jpg" locate="doc-fucking-algorithm" />
...
<Pictures figure="/pictures/mergeInterval/3.gif" locate="doc-fucking-algorithm" />
