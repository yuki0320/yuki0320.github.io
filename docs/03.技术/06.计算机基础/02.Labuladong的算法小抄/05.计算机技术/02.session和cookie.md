...
<Pictures figure="/pictures/session/1.png" locate="doc-fucking-algorithm" />

在这之后，浏览器的请求中的 `Cookie` 字段就带上了这两个 cookie：

<Pictures figure="/pictures/session/2.png" locate="doc-fucking-algorithm" />
...
<Pictures figure="/pictures/session/3.png" locate="doc-fucking-algorithm" />
...
<Pictures figure="/pictures/session/4.jpg" locate="doc-fucking-algorithm" />
