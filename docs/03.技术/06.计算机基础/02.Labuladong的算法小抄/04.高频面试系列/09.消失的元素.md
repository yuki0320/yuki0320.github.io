...
<Pictures figure="/pictures/缺失元素/title.png" locate="doc-fucking-algorithm" />
...
<Pictures figure="/pictures/缺失元素/1.jpg" locate="doc-fucking-algorithm" />


为了容易理解，我们假设先把索引补一位，然后让每个元素和自己相等的索引相对应：

<Pictures figure="/pictures/缺失元素/2.jpg" locate="doc-fucking-algorithm" />
...
<Pictures figure="/pictures/缺失元素/3.jpg" locate="doc-fucking-algorithm" />
...
<Pictures figure="/pictures/缺失元素/xor.png" locate="doc-fucking-algorithm" />
