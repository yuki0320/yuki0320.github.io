...
<Pictures figure="/pictures/dupmissing/1.gif" locate="doc-fucking-algorithm" />

如果出现重复元素 `4`，直观结果就是，索引 `4` 所对应的元素已经是负数了：

<Pictures figure="/pictures/dupmissing/2.jpg" locate="doc-fucking-algorithm" />

对于缺失元素 `3`，直观结果就是，索引 `3` 所对应的元素是正数：

<Pictures figure="/pictures/dupmissing/3.jpg" locate="doc-fucking-algorithm" />
