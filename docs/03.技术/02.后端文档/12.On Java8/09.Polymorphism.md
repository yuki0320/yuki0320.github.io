...
<Pictures figure="/images/1561774164644.png" locate="doc-onJava8" />
...
<Pictures figure="/images/1562252767216.png" locate="doc-onJava8" />
...
<Pictures figure="/images/1562406479787.png" locate="doc-onJava8" />
...
<Pictures figure="/images/1562409366638.png" locate="doc-onJava8" />
...
<Pictures figure="/images/1562409366637.png" locate="doc-onJava8" />

虽然这是一种有用且明智的方法（依赖具体情况），但是也存在缺点。派生类中接口的扩展部分在基类中不存在（不能通过基类访问到这些扩展接口），因此一旦向上转型，就不能通过基类调用这些新方法：

<Pictures figure="/images/1562409926765.png" locate="doc-onJava8" />
